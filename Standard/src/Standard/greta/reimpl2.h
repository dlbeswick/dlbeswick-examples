...
STANDARD_API size_t DEFAULT_BLOCK_SIZE();
...
protected:
    ...
    bool STANDARD_API _ok_to_recurse() const; //throw();
...
struct regex_access
{
    ...
    static bool STANDARD_API _do_match_iterative_helper_s
    (
    ...
    static bool STANDARD_API _do_match_iterative_helper_c
    (
        sub_expr_base<IterT> const * expr,
        match_param<IterT> & param,
        IterT icur
    ...
    static bool STANDARD_API _do_match_recursive_s
    (
        sub_expr_base<IterT> const * expr,
        match_param<IterT> & param,
        IterT icur
    ...
    static bool STANDARD_API _do_match_recursive_c
    (
        sub_expr_base<IterT> const * expr,
        match_param<IterT> & param,
        IterT icur
    ...
    static bool STANDARD_API _do_match_impl
    (
    ...
    static bool STANDARD_API _do_match_with_stack
    (
        rpattern_type const & pat,
        match_param<IterT> & param,
        bool const use_null
