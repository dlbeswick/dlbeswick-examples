...
#ifndef DXERROR
#define DXERROR(v,n,d) {v, (char*)TEXT(n), (char*)TEXT(d)},
#define DXERRORLAST(v,n,d) {v, (char*)TEXT(n), (char*)TEXT(d)}
#endif
#ifndef DXERROR8
...
static Error Errors[] = {
	...
	DXERROR9(0x88760362, "DXFILEERR_PRSEDXERROR", "Parse error")
...
HRESULT DXTrace(char *strFile, DWORD dwLine, HRESULT hr,
